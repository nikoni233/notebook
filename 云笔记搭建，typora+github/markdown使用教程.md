...
| HTML代码                                                     | 颜色效果                                                     |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| `<span style="background:#eef0f4;">浅灰色背景</span>`        | <span style="background:#eef0f4;">浅灰色背景</span>          |
| `<span style="background:#fbd4d0;">浅红色背景</span>`        | <span style="background:#fbd4d0;">浅红色背景</span>          |
| `<span style="background:#dad5e9;">浅紫色背景</span>`        | <span style="background:#dad5e9;">浅紫色背景</span>          |
| `<span style="background:#d4e9d5;">浅绿色背景</span>`        | <span style="background:#d4e9d5;">浅绿色背景</span>          |
| `<span style="background:#f9eda6;">浅黄色背景</span>`        | <span style="background:#f9eda6;">浅黄色背景</span>          |
| `<span style="background:#f9eda6;color:red">浅黄色背景</span>` | <span style="background:#f9eda6;color:red">浅黄色背景</span> |
